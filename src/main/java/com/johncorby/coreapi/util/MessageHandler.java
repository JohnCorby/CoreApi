...
public class MessageHandler {
    ...
    public static void msg(@NotNull CommandSender to, @NotNull MessageType type, Object... messages) {
        msgP(to, type, "", messages);
    }

    public static void msgP(@NotNull CommandSender to, @NotNull MessageType type, @NotNull String prefix, Object... messages) {
    ...
    public static void log(@NotNull MessageType type, Object... messages) {
        logP(type, "", messages);
    }
